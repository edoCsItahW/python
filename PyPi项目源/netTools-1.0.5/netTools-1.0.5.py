...
class autoBrowser:
    ...
    def __init__(self, engine: Chrome | Edge = None, *, webtype: Literal["edge", "chrome"] = "edge", hearless: bool = False, exepath: str = None):
    ...
    def getHtml(self, driver: Chrome | Edge = None, url: str = "https://www.baidu.com", *, getWhenInput: bool = False, hearless: bool = False):
        if not driver:
            driver = self.engine
    ...
    @staticmethod
    def getSoup(html: str, *, mode: Literal["lxml", "xml"] = "lxml"): return BeautifulSoup(html, mode)
