...
class dataset(Dataset):
    def __init__(self, imginfo: dict, transfrom=ToTensor(), *, size: tuple = None, channel: int = None):
    ...
    def __getitem__(self, index):
        ...
        if self.channel == 1 and image.mode != "L":
...
class dataloader:
    def __init__(self, imginfo: dict, size: tuple, channel: int, *, transfrom=ToTensor(), batchSize=None, shuffle=True):
        self.imginfo = imginfo
        self.size = size
        self.channel = channel
        self.transfrom = transfrom
