...
con1 = TypeVar("((类型: str, ), )")
con2 = TypeVar("((类型: str, 长度: int), )")
con3 = TypeVar("((类型: str, 长度: int), 是否可为空: bool, 默认值: str | bool, 是否自增: bool)")
con4 = TypeVar("((类型: str, 长度: int), 是否可为空: bool, 默认值: str | bool, 是否自增: bool, 其它约束: str | None)")
